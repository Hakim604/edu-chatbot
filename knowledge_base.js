    ...
    math: {
      ...
      c8: {
        ...
        lessons: [
          ...
          {
            axis: 'الأعداد الكسرية النسبية والأنماط العشرية',
            title: 'الكتابات العشرية لعدد كسري نسبي',
            notions: ['الكتابة العشرية للمقابل', 'الكتابة العشرية الدورية', 'الدور والجزء الدوري', 'الفصل بين الأعداد بالفاصلة العشرية'],
            competencies: ['تحويل العدد الكسري إلى كتابة عشرية دورية وتحديد الدور والتفكيك'],
            objectives: ['يتعرف التلميذ على الكتابة العشرية الدورية لعدد كسري نسبي', 'يحدد الدور والجزء الدوري بوضوح', 'يميز بين الكتابة العشرية المنتهية والدورية'],
            prerequisites: ['قسمة الأعداد الصحيحة والكسور النسبية'],
            source: SOURCE_TYPES.OFFICIAL
          },
          {
        ...
        lessons: [
          {
            axis: 'الأعداد الكسرية النسبية والأنماط العشرية',
            title: 'الكتابات العشرية لعدد كسري نسبي',
            notions: ['الكتابة العشرية الدورية', 'الدور والجزء الدوري', 'الفصل بين الأعداد بالفاصلة العشرية التونسية'],
            competencies: ['تحويل العدد الكسري إلى كتابة عشرية دورية وتحديد الدور والتفكيك في Q و R'],
            objectives: ['يتعرف التلميذ على الكتابة العشرية الدورية لعدد كسري نسبي', 'يحدد الدور والجزء الدوري بوضوح', 'يميز بين الكتابة العشرية المنتهية والدورية'],
            prerequisites: ['مجموعة الأعداد الكسرية النسبية Q', 'الكتابة العشرية للأعداد'],
            source: SOURCE_TYPES.OFFICIAL
          },
          {
